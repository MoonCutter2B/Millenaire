...
public class ServerSender {
	...
	public static void createAndSendPacketToPlayer(final DataOutput data, final EntityPlayer player) {
	...
	public static S3FPacketCustomPayload createServerPacket(final DataOutput data) {
	...
	public static void displayMerchantTradeGUI(final EntityPlayer player, final MillVillager villager) {
		final DataOutput data = getNewByteBufOutputStream();
	...
	public static void displayMillChest(final EntityPlayer player, final Point chestPos) {
	...
	/**
	 * Request the client to display the new building GUI, or the custom
	 * building edit screen if in a location
	 */
	...
	public static void displayPanel(final EntityPlayer player, final Point signPos) {
	...
	public static void displayVillageTradeGUI(final EntityPlayer player, final Building building) {
	...
	public static void sendChat(final EntityPlayer player, final EnumChatFormatting colour, final String s) {
		final ChatComponentText chat = new ChatComponentText(s);
		chat.getChatStyle().setColor(colour);
		player.addChatMessage(chat);
	}

	public static void sendLockedChestUpdatePacket(final TileEntityMillChest chest, final EntityPlayer player) {
		final DataOutput data = getNewByteBufOutputStream();
	...
	public static void sendPacketToPlayer(final Packet packet, final EntityPlayer player) {
		((EntityPlayerMP) player).playerNetServerHandler.sendPacket(packet);
	}

	public static void sendPacketToPlayersInRange(final DataOutput data, final Point p, final int range) {
		sendPacketToPlayersInRange(createServerPacket(data), p, range);
	}

	public static void sendPacketToPlayersInRange(final Packet packet, final Point p, final int range) {
	...
	public static void sendTranslatedSentence(final EntityPlayer player, final char colour, final String code, final String... values) {
	...
	public static void sendTranslatedSentenceInRange(final World world, final Point p, final int range, final char colour, final String key, final String... values) {
	...
	public static void sendVillagerSentence(final EntityPlayer player, final MillVillager v) {
	...
	public static void sendVillageSentenceInRange(final World world, final Point p, final int range, final MillVillager v) {
		for (final Object oplayer : world.playerEntities) {
			final EntityPlayer player = (EntityPlayer) oplayer;
			if (p.distanceTo(player) < range) {
	...
	public static void updatePanel(final MillWorld mw, final Point p, final String[][] lines, final int type, final Point buildingPos, final long villager_id) {
