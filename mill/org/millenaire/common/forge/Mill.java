...
public class Mill
{
	...
	public static final String versionNumber = "5.2.0b6";
	...
	protected void initBlockItems() {
		...
		byzantine_tiles = (BlockOrientedBrick) new BlockOrientedBrick("tilestopvert","tilestophor","tilestopvert","tilestophor","tilesfront","tilestophor").setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("byzantine_brick");
		byzantine_tile_slab = (BlockOrientedSlab) new BlockOrientedSlab("tilestophor","tilestopvert","tilesfront").setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("byzantine_brick_slab");
		byzantine_stone_tiles = (BlockOrientedBrick) new BlockOrientedBrick("tilestopvert","tilestophor","stone","stone","tileshalffront","tileshalfside").setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setBlockName("byzantine_mixedbrick");
		...
		parchmentIndianComplete = new ItemParchment("parchmentall",new int[]{ItemParchment.indianVillagers,ItemParchment.indianBuildings,ItemParchment.indianItems}).setUnlocalizedName("ml_marchmentIndianComplete");
		...
		parchmentMayanComplete = new ItemParchment("parchmentall",new int[]{ItemParchment.mayanVillagers,ItemParchment.mayanBuildings,ItemParchment.mayanItems}).setUnlocalizedName("ml_parchmentMayanComplete");
	...
	private void registerBlocksItemsEntities() {
		try {
			...
			GameRegistry.addRecipe(new ItemStack(byzantine_stone_tiles, 6), new Object []{"###","SSS", Character.valueOf('#'), byzantine_tiles,
