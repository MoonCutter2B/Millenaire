...
public class Mill {
	...
	public static final String versionNumber = "6.0.0b3";

	public static final String versionBound = "[6.0.0b2,7.0)";
	...
	static ArmorMaterial ARMOUR_norman = EnumHelper.addArmorMaterial("normanArmour", 66, new int[] { 3, 8, 6, 3 }, 10);
	...
	public static final String ENTITY_SKELETON = "Skeleton", ENTITY_CREEPER = "Creeper", ENTITY_SPIDER = "Spider", ENTITY_CAVESPIDER = "CaveSpider", ENTITY_ZOMBIE = "Zombie",
			ENTITY_TARGETED_GHAST = "MillGhast", ENTITY_TARGETED_BLAZE = "MillBlaze", ENTITY_TARGETED_WITHERSKELETON = "MillWitherSkeleton";

	public static final String CROP_WHEAT = "wheat", CROP_CARROT = "carrot", CROP_POTATO = "potato", CROP_RICE = "rice", CROP_TURMERIC = "turmeric", CROP_MAIZE = "maize", CROP_VINE = "vine",
			CROP_CACAO = "cacao";
	...
	protected void initBlockItems() {
		...
		cropRice = new BlockMillCrops(new String[] { "rice0", "rice0", "rice0", "rice0", "rice0", "rice0", "rice0", "rice1" }, true, false);
		cropTurmeric = new BlockMillCrops(new String[] { "turmeric0", "turmeric0", "turmeric0", "turmeric0", "turmeric0", "turmeric0", "turmeric0", "turmeric1" }, false, false);
		cropMaize = new BlockMillCrops(new String[] { "maize0", "maize0", "maize0", "maize0", "maize0", "maize0", "maize0", "maize1" }, false, true);
		cropVine = new BlockMillCrops(new String[] { "vine0", "vine0", "vine0", "vine0", "vine0", "vine0", "vine0", "vine1" }, false, false);
		...
		byzantine_tiles = (BlockOrientedBrick) new BlockOrientedBrick("tilestopvert", "tilestophor", "tilestopvert", "tilestophor", "tilesfront", "tilestophor").setHardness(2.0F).setResistance(10.0F)
				.setStepSound(Block.soundTypeStone).setBlockName("byzantine_brick");
		byzantine_tile_slab = (BlockOrientedSlab) new BlockOrientedSlab("tilestophor", "tilestopvert", "tilesfront").setHardness(2.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone)
				.setBlockName("byzantine_brick_slab");
		byzantine_stone_tiles = (BlockOrientedBrick) new BlockOrientedBrick("tilestopvert", "tilestophor", "stone", "stone", "tileshalffront", "tileshalfside").setHardness(2.0F).setResistance(10.0F)
				.setStepSound(Block.soundTypeStone).setBlockName("byzantine_mixedbrick");
		...
		denier_or = new ItemText("denier_or").setUnlocalizedName("ml_denier_or");
		denier_argent = new ItemText("denier_argent").setUnlocalizedName("ml_denier_argent");
		ciderapple = new ItemFoodMultiple("ciderapple", 0, 0, 1, 0.05f, false, 0).setUnlocalizedName("ml_ciderapple").setMaxStackSize(64);
		;
		cider = new ItemFoodMultiple("cider", 4, 15, 0, 0, true, 5).setAlwaysEdible().setUnlocalizedName("ml_cider");
		calva = new ItemFoodMultiple("calva", 8, 30, 0, 0, true, 10).setPotionEffect(Potion.damageBoost.id, 180, 0, 1f).setAlwaysEdible().setUnlocalizedName("ml_calva");
		tripes = new ItemFoodMultiple("tripes", 0, 0, 10, 1f, false, 0).setPotionEffect(Potion.regeneration.id, 90, 0, 1f).setAlwaysEdible().setUnlocalizedName("ml_tripes");

		normanPickaxe = new ItemMillenairePickaxe("normanpickaxe", TOOLS_norman).setUnlocalizedName("ml_normanPickaxe");
		normanAxe = new ItemMillenaireAxe("normanaxe", TOOLS_norman).setUnlocalizedName("ml_normanAxe");
		normanShovel = new ItemMillenaireShovel("normanshovel", TOOLS_norman).setUnlocalizedName("ml_normanShovel");
		normanHoe = new ItemMillenaireHoe("normanhoe", TOOLS_norman).setUnlocalizedName("ml_normanHoe");

		summoningWand = new ItemSummoningWand("summoningwand").setFull3D().setUnlocalizedName("ml_villageWand");

		normanBroadsword = new ItemMillenaireSword("normansword", TOOLS_norman, 0, 0, false).setUnlocalizedName("ml_normanBroadsword");
		normanHelmet = new ItemMillenaireArmour("normanhelmet", ARMOUR_norman, normanArmourId, 0).setUnlocalizedName("ml_normanHelmet");
		normanPlate = new ItemMillenaireArmour("normanplate", ARMOUR_norman, normanArmourId, 1).setUnlocalizedName("ml_normanPlate");
		normanLegs = new ItemMillenaireArmour("normanlegs", ARMOUR_norman, normanArmourId, 2).setUnlocalizedName("ml_normanLegs");
		normanBoots = new ItemMillenaireArmour("normanboots", ARMOUR_norman, normanArmourId, 3).setUnlocalizedName("ml_normanBoots");

		parchmentVillagers = new ItemParchment("parchmentvillagers", ItemParchment.villagers).setUnlocalizedName("ml_parchmentVillagers");

		parchmentBuildings = new ItemParchment("parchmentbuildings", ItemParchment.buildings).setUnlocalizedName("ml_parchmentBuildings");

		parchmentItems = new ItemParchment("parchmentitems", ItemParchment.items).setUnlocalizedName("ml_parchmentItems");

		parchmentComplete = new ItemParchment("parchmentall", new int[] { ItemParchment.villagers, ItemParchment.buildings, ItemParchment.items }).setUnlocalizedName("ml_marchmentComplete");

		boudin = new ItemFoodMultiple("boudin", 0, 0, 10, 1f, false, 0).setUnlocalizedName("ml_boudin");

		tapestry = new ItemTapestry("normantapestry", EntityMillDecoration.NORMAN_TAPESTRY).setUnlocalizedName("ml_tapestry");

		vishnu_amulet = new ItemAmuletVishnu("amulet_vishnu").setCreativeTab(Mill.tabMillenaire).setUnlocalizedName("ml_raven_amulet").setMaxStackSize(1);
		alchemist_amulet = new ItemAmuletAlchemist("amulet_alchemist").setCreativeTab(Mill.tabMillenaire).setUnlocalizedName("ml_dwarves_amulet").setMaxStackSize(1);
		yddrasil_amulet = new ItemAmuletYddrasil("amulet_yggdrasil").setCreativeTab(Mill.tabMillenaire).setUnlocalizedName("ml_yddrasil_amulet").setMaxStackSize(1);
		...
		rasgulla = new ItemFoodMultiple("rasgulla", 2, 30, 0, 0, false, 0).setPotionEffect(Potion.moveSpeed.id, 8 * 60, 1, 1f).setAlwaysEdible().setUnlocalizedName("ml_rasgullaId");
		indianstatue = new ItemTapestry("indianstatue", EntityMillDecoration.INDIAN_STATUE).setUnlocalizedName("ml_indianstatue");

		parchmentIndianVillagers = new ItemParchment("parchmentvillagers", ItemParchment.indianVillagers).setUnlocalizedName("ml_parchmentIndianVillagers");
		parchmentIndianBuildings = new ItemParchment("parchmentbuildings", ItemParchment.indianBuildings).setUnlocalizedName("ml_parchmentIndianBuildings");
		parchmentIndianItems = new ItemParchment("parchmentitems", ItemParchment.indianItems).setUnlocalizedName("ml_parchmentIndianItems");
		parchmentIndianComplete = new ItemParchment("parchmentall", new int[] { ItemParchment.indianVillagers, ItemParchment.indianBuildings, ItemParchment.indianItems })
		...
		parchmentMayanVillagers = new ItemParchment("parchmentvillagers", ItemParchment.mayanVillagers).setUnlocalizedName("ml_parchmentMayanVillagers");
		parchmentMayanBuildings = new ItemParchment("parchmentbuildings", ItemParchment.mayanBuildings).setUnlocalizedName("ml_parchmentMayanBuildings");
		parchmentMayanItems = new ItemParchment("parchmentitems", ItemParchment.mayanItems).setUnlocalizedName("ml_parchmentMayanItems");
		parchmentMayanComplete = new ItemParchment("parchmentall", new int[] { ItemParchment.mayanVillagers, ItemParchment.mayanBuildings, ItemParchment.mayanItems })
				.setUnlocalizedName("ml_parchmentMayanComplete");

		parchmentSadhu = new ItemParchment("parchmentall", new int[] { ItemParchment.sadhu }).setUnlocalizedName("ml_parchmentSadhu");

		unknownPowder = new ItemText("unknownpowder").setUnlocalizedName("ml_unknownPowder").setCreativeTab(Mill.tabMillenaire);

		udon = new ItemFoodMultiple("udon", 0, 0, 8, 0.8f, false, 0).setAlwaysEdible().setUnlocalizedName("ml_udon");

		tachiSword = new ItemMillenaireSword("tachisword", ToolMaterial.IRON, (float) 0.2, 5, false).setUnlocalizedName("ml_taichiSword");

		negationWand = new ItemNegationWand("negationwand").setFull3D().setUnlocalizedName("ml_negationWand");

		obsidianFlake = new ItemText("obsidianflake").setUnlocalizedName("ml_obsidianFlake");
		mayanMace = new ItemMillenaireSword("mayanmace", TOOLS_obsidian, 0, 0, false).setUnlocalizedName("ml_mayanMace");
		mayanPickaxe = new ItemMillenairePickaxe("mayanpickaxe", TOOLS_obsidian).setUnlocalizedName("ml_mayanPickaxe");
		mayanAxe = new ItemMillenaireAxe("mayanaxe", TOOLS_obsidian).setUnlocalizedName("ml_mayanAxe");
		mayanShovel = new ItemMillenaireShovel("mayanshovel", TOOLS_obsidian).setUnlocalizedName("ml_mayanShovel");
		mayanHoe = new ItemMillenaireHoe("mayanhoe", TOOLS_obsidian).setUnlocalizedName("ml_mayanHoe");

		yumiBow = new ItemMillenaireBow(2, (float) 0.5, "yumibow0", "yumibow1", "yumibow2", "yumibow3").setUnlocalizedName("ml_yumiBow").setFull3D();

		japaneseWarriorBlueLegs = new ItemMillenaireArmour("japanesebluelegs", ARMOUR_japaneseWarrior, japaneseWarriorBlueArmourId, 2).setUnlocalizedName("ml_japaneseWarriorBlueLegs");
		japaneseWarriorBlueHelmet = new ItemMillenaireArmour("japanesebluehelmet", ARMOUR_japaneseWarrior, japaneseWarriorBlueArmourId, 0).setUnlocalizedName("ml_japaneseWarriorBlueHelmet");
		japaneseWarriorBluePlate = new ItemMillenaireArmour("japaneseblueplate", ARMOUR_japaneseWarrior, japaneseWarriorBlueArmourId, 1).setUnlocalizedName("ml_japaneseWarriorBluePlate");
		japaneseWarriorBlueBoots = new ItemMillenaireArmour("japaneseblueboots", ARMOUR_japaneseWarrior, japaneseWarriorBlueArmourId, 3).setUnlocalizedName("ml_japaneseWarriorBlueBoots");

		japaneseWarriorRedLegs = new ItemMillenaireArmour("japaneseredlegs", ARMOUR_japaneseWarrior, japaneseWarriorRedArmourId, 2).setUnlocalizedName("ml_japaneseWarriorRedLegs");
		japaneseWarriorRedHelmet = new ItemMillenaireArmour("japaneseredhelmet", ARMOUR_japaneseWarrior, japaneseWarriorRedArmourId, 0).setUnlocalizedName("ml_japaneseWarriorRedHelmet");
		japaneseWarriorRedPlate = new ItemMillenaireArmour("japaneseredplate", ARMOUR_japaneseWarrior, japaneseWarriorRedArmourId, 1).setUnlocalizedName("ml_japaneseWarriorRedPlate");
		japaneseWarriorRedBoots = new ItemMillenaireArmour("japaneseredboots", ARMOUR_japaneseWarrior, japaneseWarriorRedArmourId, 3).setUnlocalizedName("ml_japaneseWarriorRedBoots");

		japaneseGuardLegs = new ItemMillenaireArmour("japaneseguardlegs", ARMOUR_japaneseGuard, japaneseGuardArmourId, 2).setUnlocalizedName("ml_japaneseGuardLegs");
		japaneseGuardHelmet = new ItemMillenaireArmour("japaneseguardhelmet", ARMOUR_japaneseGuard, japaneseGuardArmourId, 0).setUnlocalizedName("ml_japaneseGuardHelmet");
		japaneseGuardPlate = new ItemMillenaireArmour("japaneseguardplate", ARMOUR_japaneseGuard, japaneseGuardArmourId, 1).setUnlocalizedName("ml_japaneseGuardPlate");
		japaneseGuardBoots = new ItemMillenaireArmour("japaneseguardboots", ARMOUR_japaneseGuard, japaneseGuardArmourId, 3).setUnlocalizedName("ml_japaneseGuardBoots");

		parchmentJapaneseVillagers = new ItemParchment("parchmentvillagers", ItemParchment.japaneseVillagers).setUnlocalizedName("ml_parchmentJapaneseVillagers");
		parchmentJapaneseBuildings = new ItemParchment("parchmentbuildings", ItemParchment.japaneseBuildings).setUnlocalizedName("ml_parchmentJapaneseBuildings");
		parchmentJapaneseItems = new ItemParchment("parchmentitems", ItemParchment.japaneseItems).setUnlocalizedName("ml_parchmentJapaneseItems");
		parchmentJapaneseComplete = new ItemParchment("parchmentall", new int[] { ItemParchment.japaneseVillagers, ItemParchment.japaneseBuildings, ItemParchment.japaneseItems })
		...
		byzantineiconmedium = new ItemTapestry("byzantineicon", EntityMillDecoration.BYZANTINE_ICON_MEDIUM).setUnlocalizedName("ml_byzantineiconmedium");
		byzantineiconlarge = new ItemTapestry("byzantineicon", EntityMillDecoration.BYZANTINE_ICON_LARGE).setUnlocalizedName("ml_byzantineiconlarge");

		byzantineLegs = new ItemMillenaireArmour("byzantinelegs", ARMOUR_byzantine, byzantineArmourId, 2).setUnlocalizedName("ml_byzantineLegs");
		byzantineHelmet = new ItemMillenaireArmour("byzantinehelmet", ARMOUR_byzantine, byzantineArmourId, 0).setUnlocalizedName("ml_byzantineHelmet");
		byzantinePlate = new ItemMillenaireArmour("byzantineplate", ARMOUR_byzantine, byzantineArmourId, 1).setUnlocalizedName("ml_byzantinePlate");
		byzantineBoots = new ItemMillenaireArmour("byzantineboots", ARMOUR_byzantine, byzantineArmourId, 3).setUnlocalizedName("ml_byzantineBoots");

		byzantineMace = new ItemMillenaireSword("byzantinemace", ToolMaterial.IRON, 0, 0, true).setUnlocalizedName("ml_byzantineMace");

		clothes = (ItemClothes) new ItemClothes("byzantineclothwool", "byzantineclothsilk").setUnlocalizedName("ml_clothes");
		wineBasic = new ItemFoodMultiple("winebasic", 3, 15, 0, 0, true, 5).setAlwaysEdible().setUnlocalizedName("ml_wine_basic");
		lambRaw = new ItemFoodMultiple("lambraw", 0, 0, 2, 0.2f, false, 0).setUnlocalizedName("ml_lamb_raw");
		lambCooked = new ItemFoodMultiple("lambcooked", 0, 0, 6, 0.6f, false, 0).setUnlocalizedName("ml_lamb_cooked");
		feta = new ItemFoodMultiple("feta", 2, 15, 0, 0, false, 0).setUnlocalizedName("ml_feta");
		souvlaki = new ItemFoodMultiple("souvlaki", 0, 0, 10, 1f, false, 0).setPotionEffect(Potion.heal.id, 1, 0, 1f).setAlwaysEdible().setUnlocalizedName("ml_souvlaki");

		purse = (ItemPurse) new ItemPurse("purse").setMaxStackSize(1).setUnlocalizedName("ml_purse");

		sake = new ItemFoodMultiple("sake", 8, 30, 0, 0, true, 10).setPotionEffect(Potion.jump.id, 8 * 60, 1, 1f).setAlwaysEdible().setUnlocalizedName("ml_sake");

		cacauhaa = new ItemFoodMultiple("cacauhaa", 6, 30, 0, 0, true, 0).setPotionEffect(Potion.nightVision.id, 8 * 60, 0, 1f).setAlwaysEdible().setUnlocalizedName("ml_cacauhaa");

		mayanQuestCrown = new ItemMayanQuestCrown("mayanquestcrown", mayanQuestArmourId, 0).setUnlocalizedName("ml_mayanQuestCrown");

		ikayaki = new ItemFoodMultiple("ikayaki", 0, 0, 10, 1f, false, 0).setPotionEffect(Potion.waterBreathing.id, 8 * 60, 2, 1f).setAlwaysEdible().setUnlocalizedName("ml_ikayaki");

		wood_decoration.setBlockName("ml_wood_deco").setHardness(2.0F).setResistance(5F).setStepSound(Block.soundTypeWood);
		...
		earth_decoration.setBlockName("ml_earth_deco").setHardness(1.0F).setResistance(2F).setStepSound(Block.soundTypeGravel);
		earth_decoration.registerTexture(0, "mudbrick");
		earth_decoration.registerTexture(1, "dirtwall");

		stone_decoration.setBlockName("ml_stone_deco").setHardness(1.0F).setResistance(8F).setStepSound(Block.soundTypeStone);
		...
		path.setBlockName("ml_path").setHardness(1.0F).setResistance(2F).setStepSound(Block.soundTypeGravel);
		...
		pathSlab.setBlockName("ml_path_slab").setHardness(1.0F).setResistance(2F).setStepSound(Block.soundTypeGravel);
	...
	private void registerBlocksItemsEntities() {
		try {
			...
			EntityRegistry.registerGlobalEntityID(EntityMillDecoration.class, "ml_Tapestry", EntityRegistry.findGlobalUniqueEntityId());
			...
			FurnaceRecipes.smelting().func_151394_a(new ItemStack(stone_decoration, 1, 1), new ItemStack(stone_decoration, 1, 0), 0.3f);

			GameRegistry.addShapelessRecipe(new ItemStack(vegcurry, 1), new Object[] { rice, turmeric });
			GameRegistry.addShapelessRecipe(new ItemStack(chickencurry, 1), new Object[] { rice, turmeric, Items.chicken });

			GameRegistry.addShapelessRecipe(new ItemStack(wineBasic, 1), new Object[] { grapes, grapes, grapes, grapes, grapes, grapes });

			GameRegistry.addRecipe(new ItemStack(masa, 1), new Object[] { "###", Character.valueOf('#'), maize });
			GameRegistry.addRecipe(new ItemStack(wah, 1), new Object[] { "#X#", Character.valueOf('#'), maize, Character.valueOf('X'), Items.chicken });

			GameRegistry.addRecipe(new ItemStack(byzantine_tile_slab, 6), new Object[] { "###", Character.valueOf('#'), byzantine_tiles });
			GameRegistry.addRecipe(new ItemStack(byzantine_stone_tiles, 6), new Object[] { "###", "SSS", Character.valueOf('#'), byzantine_tiles, Character.valueOf('S'), Blocks.stone });

			for (int meta = 0; meta < 16; meta++) {
				GameRegistry.addRecipe(new ItemStack(Mill.pathSlab, 3, meta), "xxx", 'x', new ItemStack(Mill.path, 1, meta));
			}
