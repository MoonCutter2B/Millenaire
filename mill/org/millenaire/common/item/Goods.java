...
public class Goods {
	...
	public static class ItemMillenaireArmour extends ItemArmor {
		...
		public ItemMillenaireArmour(String iconName, ArmorMaterial material, int armourId, int type) {
	...
	public static class ItemMillenaireAxe extends ItemAxe {
		...
		public ItemMillenaireAxe(String iconName,ToolMaterial material) {
			super(material);
			this.iconName=iconName;
			setCreativeTab(Mill.tabMillenaire);
		}
	...
	public static class ItemMillenaireHoe extends ItemHoe {
		...
		public ItemMillenaireHoe(String iconName,ToolMaterial material) {
			super(material);
			setCreativeTab(Mill.tabMillenaire);
			this.iconName=iconName;
		}
	...
	public static class ItemMillenairePickaxe extends ItemPickaxe {
		...
		public ItemMillenairePickaxe(String iconName,ToolMaterial material) {
			super(material);
			this.iconName=iconName;
			setCreativeTab(Mill.tabMillenaire);
		}
	...
	public static class ItemMillenaireShovel extends ItemSpade {
		...
		public ItemMillenaireShovel(String iconName,ToolMaterial material) {
			super(material);
	...
	public static class ItemMillenaireSword extends ItemSword implements IItemInitialEnchantmens {
		...
		boolean knockback;
		public ItemMillenaireSword(String iconName,ToolMaterial material,float criticalChance,int criticalMultiple,boolean knockback) {
			super(material);
		...
		try {
			...
			while ((line=reader.readLine()) != null) {
				if ((line.trim().length() > 0) && !line.startsWith("//")) {
					...
					if (temp.length>2) {
						Item item=(Item) Item.itemRegistry.getObject(temp[1]);

						if (item!=null) {
							goodsName.put(temp[0], new InvItem(item,Integer.parseInt(temp[2])));
						} else {
							Block block=(Block) Block.blockRegistry.getObject(temp[1]);
