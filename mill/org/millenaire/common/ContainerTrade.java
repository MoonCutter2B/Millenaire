...
public class ContainerTrade extends Container {
	...
	public static class MerchantSlot extends Slot {
		...
		public MerchantSlot(final MillVillager merchant, final EntityPlayer player, final Goods good, final int xpos, final int ypos) {
	...
	public static class TradeSlot extends Slot {
		...
		public TradeSlot(final Building building, final EntityPlayer player, final boolean sellingSlot, final Goods good, final int xpos, final int ypos) {
	...
	@Override
	public ItemStack slotClick(final int slotNb, final int buttonNumber, final int shiftPressed, final EntityPlayer player) {
