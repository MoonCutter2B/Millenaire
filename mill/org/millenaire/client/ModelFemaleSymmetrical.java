...
public class ModelFemaleSymmetrical extends ModelBiped {
	...
	public ModelFemaleSymmetrical(final float f) {
		this(f, 0.0F);
	}
	...
	public ModelFemaleSymmetrical(final float f, final float f1) {
		...
		bipedUpperBody = new ModelRenderer(this, 16, 17);
	...
	public void setRotationAngles(final float f, final float f1,
		...
		if (onGround > -9990F) {
			float f6 = onGround;
			bipedUpperBody.rotateAngleY = MathHelper.sin(MathHelper
					.sqrt_float(f6) * 3.141593F * 2.0F) * 0.2F;
			bipedRightArm.rotationPointZ = MathHelper
					.sin(bipedUpperBody.rotateAngleY) * 5F;
			bipedRightArm.rotationPointX = -MathHelper
					.cos(bipedUpperBody.rotateAngleY) * 5F;
