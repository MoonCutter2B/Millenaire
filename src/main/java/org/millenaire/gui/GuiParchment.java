...
public class GuiParchment extends GuiScreen {
	final static ResourceLocation PARCHMENTGUI = new ResourceLocation(
			Reference.MOD_ID + ":textures/gui/ML_parchment.png");
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.fontRendererObj.drawString(drawTitle, (this.width - this.fontRendererObj.getStringWidth(drawTitle)) / 2, 6,
				0);
