	...
	public static class MillConfigGui extends GuiConfig {
		public MillConfigGui(GuiScreen parentScreen) {
			super(parentScreen, getConfigElements(), Reference.MOD_ID, false, false,
					I18n.format("gui.millConfig.mainTitle"));
		}

		private static List<IConfigElement> getConfigElements() {
			List<IConfigElement> list = new ArrayList<IConfigElement>();

			list.add(new DummyCategoryElement("UI Options", "gui.millConfig.ctgy.uiOptions",
					CategoryEntryUIOptions.class));
			list.add(new DummyCategoryElement("World Generation Options", "gui.millConfig.ctgy.worldGen",
					CategoryEntryWorldGen.class));
			list.add(new DummyCategoryElement("Village Behavior Options", "gui.millConfig.ctgy.villageBehavior",
					CategoryEntryVillageBev.class));

			return list;
		}

		public static class CategoryEntryUIOptions extends CategoryEntry {
			public CategoryEntryUIOptions(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
					IConfigElement prop) {
		...
		public static class CategoryEntryVillageBev extends CategoryEntry {
			public CategoryEntryVillageBev(GuiConfig owningScreen, GuiConfigEntries owningEntryList,
					IConfigElement prop) {
				super(owningScreen, owningEntryList, prop);
			}
