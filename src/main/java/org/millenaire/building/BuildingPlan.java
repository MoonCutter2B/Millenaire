...
public class BuildingPlan {
	...
	// Note: This should count down to 0 for final level, used by Construction
	// Project MillSign.
	int buildLevel;
	...
	public BuildingLocation findBuildingLocation(VillageGeography vg, MillPathNavigate pathing, BlockPos center,
			int maxRadius, Random random, EnumFacing orientation) {
	...
	private boolean freeBuild(IBlockState state) {
		if (state.getBlock() == Blocks.dirt || state.getBlock() == Blocks.water || state.getBlock() == Blocks.leaves
				|| state.getBlock() == Blocks.leaves2 || state.getBlock() == Blocks.grass
				|| state.getBlock() == Blocks.tallgrass || state.getBlock() == Blocks.red_flower
				|| state.getBlock() == Blocks.yellow_flower || state.getBlock() == Blocks.double_plant
				|| state.getBlock() == Blocks.deadbush || state.getBlock() == BlockMillPath.blockMillPath
				|| state.getBlock() == BlockMillPath.blockMillPathSlab
				|| state.equals(BlockDecorative.blockDecorativeEarth.getDefaultState()
						.withProperty(BlockDecorativeEarth.VARIANT, BlockDecorativeEarth.EnumType.DIRTWALL))) {
			return true;
		} else
			return false;
	}
	...
	private void computeCost() {
		...
		int plankCost = 0, plankOakCost = 0, plankSpruceCost = 0, plankBirchCost = 0, plankJungleCost = 0,
				plankAcaciaCost = 0, plankDarkCost = 0, glassPaneCost = 0, byzBricksHalf = 0;
			...
			for (int j = 0; j < length; j++) {
				for (int k = 0; k < width; k++) {
					...
					if (state.getBlock() == Blocks.log
							&& state.getValue(BlockOldLog.VARIANT) == BlockPlanks.EnumType.OAK)
						plankOakCost += 4;
					else if (state.getBlock() == Blocks.log
							&& state.getValue(BlockOldLog.VARIANT) == BlockPlanks.EnumType.SPRUCE)
						plankSpruceCost += 4;
					else if (state.getBlock() == Blocks.log
							&& state.getValue(BlockOldLog.VARIANT) == BlockPlanks.EnumType.BIRCH)
						plankBirchCost += 4;
					else if (state.getBlock() == Blocks.log
							&& state.getValue(BlockOldLog.VARIANT) == BlockPlanks.EnumType.JUNGLE)
						plankJungleCost += 4;
					else if (state.getBlock() == Blocks.log
							&& state.getValue(BlockNewLog.VARIANT) == BlockPlanks.EnumType.ACACIA)
						plankAcaciaCost += 4;
					else if (state.getBlock() == Blocks.log
							&& state.getValue(BlockNewLog.VARIANT) == BlockPlanks.EnumType.DARK_OAK)
						plankJungleCost += 4;
					else if (state.getBlock() == Blocks.planks
							&& state.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.OAK)
						plankOakCost++;
					else if (state.getBlock() == Blocks.planks
							&& state.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.SPRUCE)
						plankSpruceCost++;
					else if (state.getBlock() == Blocks.planks
							&& state.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.BIRCH)
						plankBirchCost++;
					else if (state.getBlock() == Blocks.planks
							&& state.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.JUNGLE)
						plankJungleCost++;
					else if (state.getBlock() == Blocks.planks
							&& state.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.ACACIA)
						plankAcaciaCost++;
					else if (state.getBlock() == Blocks.planks
							&& state.getValue(BlockPlanks.VARIANT) == BlockPlanks.EnumType.DARK_OAK)
						plankDarkCost++;
						...
						addToCost(new ItemStack(Blocks.stone), 1);
							...
							&& state.getValue(BlockStoneSlab.VARIANT) == BlockStoneSlab.EnumType.STONE)
						addToCost(new ItemStack(Blocks.stone), 1);
					else if (state.getBlock() == Blocks.stone_slab
							&& state.getValue(BlockStoneSlab.VARIANT) == BlockStoneSlab.EnumType.SAND)
						addToCost(new ItemStack(Blocks.sandstone), 1);
					else if (state.getBlock() == Blocks.stone_slab
							&& state.getValue(BlockStoneSlab.VARIANT) == BlockStoneSlab.EnumType.WOOD)
						plankCost++;
					else if (state.getBlock() == Blocks.stone_slab
							&& state.getValue(BlockStoneSlab.VARIANT) == BlockStoneSlab.EnumType.COBBLESTONE)
						addToCost(new ItemStack(Blocks.cobblestone), 1);
					else if (state.getBlock() == Blocks.stone_slab
							&& state.getValue(BlockStoneSlab.VARIANT) == BlockStoneSlab.EnumType.BRICK)
						addToCost(new ItemStack(Blocks.brick_block), 1);
					else if (state.getBlock() == Blocks.stone_slab
							&& state.getValue(BlockStoneSlab.VARIANT) == BlockStoneSlab.EnumType.SMOOTHBRICK)
						addToCost(new ItemStack(Blocks.stone), 1);

					else if (state.getBlock() == Blocks.wooden_slab
							&& state.getValue(BlockWoodSlab.VARIANT) == BlockPlanks.EnumType.OAK)
						plankOakCost++;
					else if (state.getBlock() == Blocks.wooden_slab
							&& state.getValue(BlockWoodSlab.VARIANT) == BlockPlanks.EnumType.SPRUCE)
						plankSpruceCost++;
					else if (state.getBlock() == Blocks.wooden_slab
							&& state.getValue(BlockWoodSlab.VARIANT) == BlockPlanks.EnumType.BIRCH)
						plankBirchCost++;
					else if (state.getBlock() == Blocks.wooden_slab
							&& state.getValue(BlockWoodSlab.VARIANT) == BlockPlanks.EnumType.JUNGLE)
						plankJungleCost++;
					else if (state.getBlock() == Blocks.wooden_slab
							&& state.getValue(BlockWoodSlab.VARIANT) == BlockPlanks.EnumType.ACACIA)
						plankAcaciaCost++;
					else if (state.getBlock() == Blocks.wooden_slab
							&& state.getValue(BlockWoodSlab.VARIANT) == BlockPlanks.EnumType.DARK_OAK)
						plankDarkCost++;
					...
					// plankCost += 7;
						...
						plankCost += 6;
					else if (state.getBlock() == Blocks.bed
		...
		if (plankOakCost > 0) {
			addToCost(
					new ItemStack(Blocks.log, 1, Blocks.log.getMetaFromState(
		...
		if (plankSpruceCost > 0) {
			addToCost(
					new ItemStack(Blocks.log, 1,
							Blocks.log.getMetaFromState(Blocks.log.getDefaultState().withProperty(BlockOldLog.VARIANT,
									BlockPlanks.EnumType.SPRUCE))),
					(int) Math.max(Math.ceil(plankSpruceCost * 1.0 / 4), 1));
		}
		...
		if (plankAcaciaCost > 0) {
			addToCost(
					new ItemStack(Blocks.log2, 1,
							Blocks.log2.getMetaFromState(Blocks.log2.getDefaultState().withProperty(BlockNewLog.VARIANT,
	...
	private LocationReturn testLocation(VillageGeography vg, BlockPos center, int x, int z, EnumFacing facing,
			MillPathNavigate pathing) {
		...
		orientation = EnumFacing
				.getFront((orientation.getHorizontalIndex() + buildingOrientation.getHorizontalIndex()) % 4);
		...
		final BuildingLocation l = new BuildingLocation(this,
				new BlockPos(x + vg.mapStartX, altitude, z + vg.mapStartZ), orientation);
	...
	public BuildingBlock[] getBuildingPoints(World worldIn, BuildingLocation location, boolean villageGeneration) {
				...
				for (int k = -areaToClear; k < width + areaToClear; k++) {
					for (int i = height + 50; i > -1; i--) {
						...
						if (i >= offset - 1) {
							...
							final BlockPos p = adjustForOrientation(x, y + i, z, j - lengthOffset, ak - widthOffset,
									orientation);
							bblocks.add(new BuildingBlock(null, p, BuildingBlock.CLEARGROUND));
						} else {
							final BlockPos p = adjustForOrientation(x, y + i, z, j - lengthOffset, k - widthOffset,
									orientation);
		...
		for (int i = height - 1; i >= 0; i--) {
			for (int j = 0; j < length; j++) {
				for (int k = 0; k < width; k++) {
					...
					BlockPos p = adjustForOrientation(x, y + i + depth, z, j - lengthOffset, ak - widthOffset,
							orientation);
		...
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < length; j++) {
				for (int k = 0; k < width; k++) {
					...
					BlockPos p = adjustForOrientation(x, y + ai + depth, z, j - lengthOffset, ak - widthOffset,
							orientation);
						...
						if (prop.getName().equals("facing")) {
							if (((EnumFacing) state.getValue(prop)).getAxis() != EnumFacing.Axis.Y)
								state = state.withProperty(prop,
										EnumFacing
												.getHorizontal(((EnumFacing) state.getValue(prop)).getHorizontalIndex()
														+ orientation.getHorizontalIndex() % 4));
		...
		for (int i = 0; i < bblocks.size(); i++) {
			...
			if ((state == bb.blockState && special == 0
					|| block == Blocks.grass && bb.blockState.getBlock() == Blocks.dirt) && bb.specialBlock == 0)
				toDelete[i] = true;
				...
				toDelete[i] = true;
			else if (bb.specialBlock == BuildingBlock.PRESERVEGROUNDDEPTH
					&& CommonUtilities.getValidGroundBlock(block, false) == block)
				toDelete[i] = true;
			else if (bb.specialBlock == BuildingBlock.PRESERVEGROUNDSURFACE
					&& CommonUtilities.getValidGroundBlock(block, true) == block)
				toDelete[i] = true;
			else {
	...
	public static BlockPos adjustForOrientation(final int x, final int y, final int z, final int xoffset,
			final int zoffset, final EnumFacing orientation) {
	...
	private boolean firstPass(IBlockState state) {
		if (state.getBlock().getCreativeTabToDisplayOn() == CreativeTabs.tabBlock)
			return true;
		else if (state.getBlock() instanceof BlockDecorativeEarth || state.getBlock() instanceof BlockDecorativeWood
				|| state.getBlock() instanceof BlockDecorativeStone)
			return true;
		else if (state.getBlock() == BlockDecorative.byzantineStoneTile
				|| state.getBlock() == BlockDecorative.byzantineTile
				|| state.getBlock() == BlockDecorative.byzantineTileSlab
				|| state.getBlock() == BlockDecorative.byzantineTileSlabDouble)
			return true;
		else
			return false;
	}
	...
	private void setReferencePositions(IBlockState state, BlockPos pos, BuildingLocation location) {
		...
		else if (state.getBlock() == StoredPosition.storedPosition
				&& state.getValue(StoredPosition.VARIANT) == StoredPosition.EnumType.TRADEPOS)
		...
		// else if BlockMillSign add to Sign Positions
			...
			location.sleepPos.add(pos);
				...
				&& state.getValue(StoredPosition.VARIANT) == StoredPosition.EnumType.SLEEPPOS)
			location.sleepPos.add(pos);
		else if (state.getBlock() == StoredPosition.storedPosition
				&& state.getValue(StoredPosition.VARIANT) == StoredPosition.EnumType.SOURCEPOS)
			...
			location.craftPos.add(pos);
				...
				&& state.getValue(StoredPosition.VARIANT) == StoredPosition.EnumType.HIDEPOS)
			location.hidePos.add(pos);
		else if (state.getBlock() == StoredPosition.storedPosition
				&& state.getValue(StoredPosition.VARIANT) == StoredPosition.EnumType.DEFENDPOS)
	...
	public static void preinitialize() {
		// Norman Buildings
		normanCommunauteA0 = new BuildingPlan(MillCulture.normanCulture, 0)
				.setNameAndType("Communauté", new String[] { "normanGuildMaster" }, new String[0])
				.setLengthWidth(11, 13).setHeightDepth(13, -6).setArea(3).setDistance(0, 1)
				.setOrientation(EnumFacing.getHorizontal(2)).setPlan(new IBlockState[][][] { { {} } });
		// Hindi Buildings
	}
