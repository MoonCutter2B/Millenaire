...
public class MillItems {
	...
	public static void render() {
		...
		renderItem.getItemModelMesher().register(denier, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":denier", "inventory"));
		renderItem.getItemModelMesher().register(denierOr, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":denierOr", "inventory"));
		renderItem.getItemModelMesher().register(denierArgent, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":denierArgent", "inventory"));

		renderItem.getItemModelMesher().register(silk, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":silk", "inventory"));
		renderItem.getItemModelMesher().register(obsidianFlake, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":obsidianFlake", "inventory"));
		renderItem.getItemModelMesher().register(unknownPowder, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":unknownPowder", "inventory"));

		renderItem.getItemModelMesher().register(woolClothes, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":woolClothes", "inventory"));
		renderItem.getItemModelMesher().register(silkClothes, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":silkClothes", "inventory"));
		renderItem.getItemModelMesher().register(galianiteDust, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":galianiteDust", "inventory"));
	}
}
