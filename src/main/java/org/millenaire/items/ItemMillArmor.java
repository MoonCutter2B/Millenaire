...
public class ItemMillArmor 
{
    ...
    //Declarations
    	...
    	{
    		normanHelmet = new ItemArmor(ARMOR_norman, 2, 0).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("normanHelmet");
    		GameRegistry.registerItem(normanHelmet, "normanHelmet");
    		normanChestplate = new ItemArmor(ARMOR_norman, 2, 1).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("normanChestplate");
    		GameRegistry.registerItem(normanChestplate, "normanChestplate");
    		normanLeggings = new ItemArmor(ARMOR_norman, 2, 2).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("normanLeggings");
    		GameRegistry.registerItem(normanLeggings, "normanLeggings");
    		normanBoots = new ItemArmor(ARMOR_norman, 2, 3).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("normanBoots");
    		GameRegistry.registerItem(normanBoots, "normanBoots");
    		
    		byzantineHelmet = new ItemArmor(ARMOR_byzantine, 2, 0).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("byzantineHelmet");
    		GameRegistry.registerItem(byzantineHelmet, "byzantineHelmet");
    		byzantineChestplate = new ItemArmor(ARMOR_byzantine, 2, 1).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("byzantineChestplate");
    		GameRegistry.registerItem(byzantineChestplate, "byzantineChestplate");
    		byzantineLeggings = new ItemArmor(ARMOR_byzantine, 2, 2).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("byzantineLeggings");
    		GameRegistry.registerItem(byzantineLeggings, "byzantineLeggings");
    		byzantineBoots = new ItemArmor(ARMOR_byzantine, 2, 3).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("byzantineBoots");
    		GameRegistry.registerItem(byzantineBoots, "byzantineBoots");
    		
    		japaneseGuardHelmet = new ItemArmor(ARMOR_japaneseGuard, 2, 0).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseGuardHelmet");
    		GameRegistry.registerItem(japaneseGuardHelmet, "japaneseGuardHelmet");
    		japaneseGuardChestplate = new ItemArmor(ARMOR_japaneseGuard, 2, 1).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseGuardChestplate");
    		GameRegistry.registerItem(japaneseGuardChestplate, "japaneseGuardChestplate");
    		japaneseGuardLeggings = new ItemArmor(ARMOR_japaneseGuard, 2, 2).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseGuardLeggings");
    		GameRegistry.registerItem(japaneseGuardLeggings, "japaneseGuardLeggings");
    		japaneseGuardBoots = new ItemArmor(ARMOR_japaneseGuard, 2, 3).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseGuardBoots");
    		GameRegistry.registerItem(japaneseGuardBoots, "japaneseGuardBoots");
    		
    		japaneseBlueHelmet = new ItemArmor(ARMOR_japaneseWarriorBlue, 2, 0).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseBlueHelmet");
    		GameRegistry.registerItem(japaneseBlueHelmet, "japaneseBlueHelmet");
    		japaneseBlueChestplate = new ItemArmor(ARMOR_japaneseWarriorBlue, 2, 1).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseBlueChestplate");
    		GameRegistry.registerItem(japaneseBlueChestplate, "japaneseBlueChestplate");
    		japaneseBlueLeggings = new ItemArmor(ARMOR_japaneseWarriorBlue, 2, 2).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseBlueLeggings");
    		GameRegistry.registerItem(japaneseBlueLeggings, "japaneseBlueLeggings");
    		japaneseBlueBoots = new ItemArmor(ARMOR_japaneseWarriorBlue, 2, 3).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseBlueBoots");
    		GameRegistry.registerItem(japaneseBlueBoots, "japaneseBlueBoots");
    		
    		japaneseRedHelmet = new ItemArmor(ARMOR_japaneseWarriorRed, 2, 0).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseRedHelmet");
    		GameRegistry.registerItem(japaneseRedHelmet, "japaneseRedHelmet");
    		japaneseRedChestplate = new ItemArmor(ARMOR_japaneseWarriorRed, 2, 1).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseRedChestplate");
    		GameRegistry.registerItem(japaneseRedChestplate, "japaneseRedChestplate");
    		japaneseRedLeggings = new ItemArmor(ARMOR_japaneseWarriorRed, 2, 2).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseRedLeggings");
    		GameRegistry.registerItem(japaneseRedLeggings, "japaneseRedLeggings");
    		japaneseRedBoots = new ItemArmor(ARMOR_japaneseWarriorRed, 2, 3).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("japaneseRedBoots");
    		GameRegistry.registerItem(japaneseRedBoots, "japaneseRedBoots");
    		
    		mayanQuestCrown = new mayanQuestCrown(ARMOR_mayanQuest, 2, 0).setCreativeTab(Millenaire.tabMillenaire).setUnlocalizedName("mayanQuestCrown");
