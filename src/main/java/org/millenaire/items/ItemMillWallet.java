...
public class ItemMillWallet extends Item {
	...
	public ItemStack onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn) {
		if (playerIn.inventory.hasItem(MillItems.denier) || playerIn.inventory.hasItem(MillItems.denierArgent)
				|| playerIn.inventory.hasItem(MillItems.denierOr))
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		if (stack.hasTagCompound()) {
			...
			if (nbt.hasKey("DenierOr") && nbt.getInteger("DenierOr") > 0) {
				...
				tooltip.add(EnumChatFormatting.YELLOW + or + EnumChatFormatting.GRAY + argent + EnumChatFormatting.GOLD
						+ denier);
	...
	public void addDenierToWallet(ItemStack stack, EntityPlayer playerIn) {
	...
	public void emptyWallet(ItemStack stack, EntityPlayer playerIn) {
		if (stack.hasTagCompound()) {
			NBTTagCompound nbt = stack.getTagCompound();
	...
	public static void preinitialize() {
		itemMillPurse = new ItemMillWallet().setCreativeTab(Millenaire.tabMillenaire)
				.setUnlocalizedName("itemMillPurse");
	...
	public static void render() {
		...
		renderItem.getItemModelMesher().register(itemMillPurse, 0,
				new ModelResourceLocation(Reference.MOD_ID + ":itemMillPurse", "inventory"));
	}
}
