...
public class ItemMillSign extends Item {
		...
		if (side == EnumFacing.DOWN) {
			...
			if (!playerIn.canPlayerEdit(pos, side, stack)) {
				...
				worldIn.setBlockState(pos,
						BlockMillSign.blockMillSign.getDefaultState().withProperty(BlockMillSign.FACING,
								side)/*
										 * Blocks.wall_sign.getDefaultState().withProperty(BlockWallSign.FACING, side)
										 */,
						3);
	...
	public static void render() {
		...
		renderItem.getItemModelMesher().register(itemMillSign, 0,
